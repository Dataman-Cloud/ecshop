...
<title>汽车_DMECSHOP演示站 - Powered by ECShop</title>
...
<div class="blank"></div>
 <div id="ur_here">
当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">汽车</a> 
</div>
</div>
<div class="blank"></div>
  ...
  <div class="AreaR">
		 ...
		 <div class="box_1">
			<h3><span>商品筛选</span></h3>
			  ...
			  <strong>品牌：</strong>
														<span>全部</span>
																			<a href="category.php?id=1&amp;brand=1&amp;price_min=0&amp;price_max=0">BMW</a>&nbsp;
												</div>
											 </div>
		</div>
		<div class="blank"></div>
...
<div class="box">
 <div class="box_1">
  ...
  <a href="category.php?category=1&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list"><img src="themes/ecmoban/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
  <a href="category.php?category=1&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/ecmoban/images/shop_price_default.gif" alt="按价格排序"></a>
  <a href="category.php?category=1&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/ecmoban/images/last_update_default.gif" alt="按更新时间排序"></a>
...
<div id="footer">
 ...
 北京市朝阳区大望京商务园区宏泰东街浦项中心A座806-807        Tel: 123456789               <a href="http://wpa.qq.com/msgrd?V=1&amp;Uin=123456789&amp;Site=DMECSHOP&amp;Menu=yes" target="_blank"><img src="http://wpa.qq.com/pa?p=1:123456789:4" height="16" border="0" alt="QQ" /> 123456789</a>
  ...
  <a href="http://www.ecshop.com/license.php?product=ecshop_b2c&url=http%3A%2F%2F123.59.56.132%2F" target="_blank"
>&nbsp;&nbsp;Licensed</a><br />
