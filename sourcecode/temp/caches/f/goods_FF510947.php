...
<title>bmw2_汽车_DMECSHOP演示站 - Powered by ECShop</title>
...
<div class="blank"></div>
 <div id="ur_here">
当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">汽车</a> <code>&gt;</code> bmw2 
</div>
</div>
<div class="blank"></div>
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     <div class="imgInfo">
     <a href="http://pic4.bbzhi.com/qichebizhi/gaoqingqichekuanpingbizhixiazai/gaoqingqichekuanpingbizhixiazai_385371_11.jpg" id="zoom1" class="MagicZoom MagicThumb" title="bmw2">
      <img src="http://pic4.bbzhi.com/qichebizhi/gaoqingqichekuanpingbizhixiazai/gaoqingqichekuanpingbizhixiazai_385371_11.jpg" alt="bmw2" width="310px;" height="310px"/>
     </a>
     <div class="blank5"></div>
    <div style="text-align:center; position:relative; width:100%;">
               <a href="javascript:;" onclick="window.open('gallery.php?id=2'); return false;"><img alt="zoom" src="themes/ecmoban/images/zoom.gif" /></a>
            <a href="goods.php?id=1"><img style="position: absolute;right:0;"  alt="next" src="themes/ecmoban/images/down.gif" /></a>
            </div>
      ...
      <div class="picture" id="imglist">
           ...
           <a  href="http://pic4.bbzhi.com/qichebizhi/gaoqingqichekuanpingbizhixiazai/gaoqingqichekuanpingbizhixiazai_385371_11.jpg"
    	rel="zoom1" 
        rev="http://pic4.bbzhi.com/qichebizhi/gaoqingqichekuanpingbizhixiazai/gaoqingqichekuanpingbizhixiazai_385371_11.jpg"
        title="">
        <img src="images/201511/thumb_img/2_thumb_P_1448424426392.jpg" alt="bmw2" class="onbg" /></a>
...
<script type="text/javascript">
	mypicBg();
     ...
     <form action="javascript:addToCart(2)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      ...
      <li class="padd">
      <a href="javascript:addToCart(2)"><img src="themes/ecmoban/images/goumai2.gif" /></a>
      <a href="javascript:collect(2)"><img src="themes/ecmoban/images/shoucang2.gif" /></a>
            <a href="user.php?act=affiliate&goodsid=2" ><img src="themes/ecmoban/images/tuijian.gif" /></a>
            </li>
